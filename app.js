const labels = {overview:'نظرة عامة', assessment:'التقييمات', roadmap:'خارطة التحسين', reports:'التقارير', researcher:'مساحة الباحث', methodology:'المنهجية', 'admin-users':'إدارة المستخدمين'};
