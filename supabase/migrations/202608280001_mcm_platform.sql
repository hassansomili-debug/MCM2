...
ALTER TABLE assessment_context ENABLE ROW LEVEL SECURITY;
ALTER TABLE instrument_profile_fields ENABLE ROW LEVEL SECURITY;
...
ALTER TABLE response_item_scores ENABLE ROW LEVEL SECURITY;
ALTER TABLE score_run_dimensions ENABLE ROW LEVEL SECURITY;
ALTER TABLE score_run_totals ENABLE ROW LEVEL SECURITY;
