...
_PLAYBOOK = {
    ...
    "MCM07": {
        "name_ar": "المأسسة وقابلية التوسع الاتصالي",
...
def _relationship_reading(sanitized: Mapping[str, Any]) -> str:
    ...
    if alignment == "EFFICIENCY_AHEAD_OF_MATURITY":
        return "تتقدم الكفاءة الاتصالية على مستوى المأسسة؛ تركز الخطة على تثبيت الممارسات وتقليل اعتمادها على الأفراد، دون ادعاء سببية."
